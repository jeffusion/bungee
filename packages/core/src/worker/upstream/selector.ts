 ...
 * Implements priority-based weighted random selection algorithm
 */
 ...
 * // Will select server1 or server2 (priority 1) with 2:1 weight ratio
 * // server3 will only be selected if priority 1 group is exhausted
 * ```
 */
export const selectUpstream: UpstreamSelector = (upstreams) => {
